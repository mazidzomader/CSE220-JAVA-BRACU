...
public class BinaryTreeTester {
    ...
    public static void main(String[] args) {
        ...
        if( input.equals("6") || input.equals("") ) task6Bonus();
    ...
    public static void task6Bonus(){
        Object[] tree;
        BTNode root;
        taskPrint("================== TASK#6 (Bonus) =================");
        ...
        Integer returnedInteger = Task6Bonus.levelSum(root);
        System.out.println(bold+"\n::Your Output::");
        System.out.println(returnedInteger);
        
        if( Objects.equals(returnedInteger, 4) ) successPrint("Task#6 (Bonus)");
        else failedPrint("Task#6 (Bonus)");
